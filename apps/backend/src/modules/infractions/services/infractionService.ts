...
//     const rawEvents = await this.telemetryEventRepository.findByDriverAndClassifications(
//       String(driver.external_id),
//       infractionClassifications
//     );

//     // ✅ MAPEAMENTO ROBUSTO - lida com dados órfãos
//     return rawEvents.map(event => ({
//       id: Number(event.external_id) || 0,
//       description: event.event_type_description || 'Tipo de evento não catalogado',
