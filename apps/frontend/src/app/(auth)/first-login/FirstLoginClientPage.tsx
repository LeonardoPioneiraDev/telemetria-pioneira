...
//     try {
//       // 🔧 CORREÇÃO: Usar a API correta baseada na documentação
//       // Como é primeiro login, usamos a mesma API de reset de senha
...
//       // Redireciona para o login para que o usuário entre com a nova senha
//       setTimeout(() => {
//         router.push('/login');
//       }, 2000);
//     } catch (error: any) {
